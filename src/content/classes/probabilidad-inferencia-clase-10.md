...
order: 18
classType: "clase"
description: "Distribuciones de probabilidad continua: - Distribución Normal - Distribución Normal Estándar Teoremas de Aproximación: - Binomial a Poisson - Binomial a Normal"
math: true
...
la varianza $\sigma^2=1$, recibe el nombre de distribución normal
...
$$\begin{align*}Z=\frac{x-\mu}{\sigma}\end{align*}$$
 conocida como
**estandarización**, se tendrá que $Z\sim N(0,1)$, con $z_1$ y
$z_2$ las dos constantes transformadas.

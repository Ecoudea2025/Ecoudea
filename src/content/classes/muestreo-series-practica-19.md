...
order: 6
classType: "practica"
description: "Ejercicios sobre: - Identificación de componentes de una serie de tiempo. - Función de autocorrelación. - Funciones de pérdida. - Modelo de regresión lineal simple."
math: true
...
1.  A partir de las series de tiempo suministradas en el archivo de los
    siguientes enlaces
    <a href="https://github.com/jiperezga/jiperezga.github.io/raw/master/Dataset/CO2.xlsx" target="_blank" rel="noopener noreferrer">GeneraciónCO2</a>.

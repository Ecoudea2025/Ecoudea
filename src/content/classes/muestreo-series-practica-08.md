...
order: 17
classType: "practica"
description: "Ejercicios sobre identificación de procesos: - AR - MA - ARMA - SAR - SMA - SARMA"
math: true
...
1.  Suponga las siguientes series de tiempo suministradas en los
    archivos de los siguientes enlaces <a href="https://github.com/jiperezga/jiperezga.github.io/raw/master/Dataset/MySTSim5.xlsx" target="_blank" rel="noopener noreferrer">Serie
    5</a>,
...
![](/assets/images/Practica03unnamed-chunk-4-1.png)

    ################### Caso 2 ###################

![](/assets/images/Practica03unnamed-chunk-4-2.png)

    ################### Caso 3 ###################

    Reordering variables and trying again:

![](/assets/images/Practica03unnamed-chunk-4-3.png)
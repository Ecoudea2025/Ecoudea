...
order: 3
classType: "guia"
description: "Guía detallada para la instalación del programa Python - Anaconda en Windows."
...
haga click en el siguiente enlace <a href="https://www.anaconda.com/distribution/#windows" target="_blank" rel="noopener noreferrer">(Descargar
Python-Anaconda)</a>.
Una vez realizado click en el enlace, se abrirá la siguiente venta

![](/assets/images/GuiaW17.jpg) Haga click en el recuadro rojo que

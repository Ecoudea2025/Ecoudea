...
order: 4
classType: "guia"
description: "Guía detallada para la instalación del programa Python - Anaconda en Ubuntu."
...
haga click en el siguiente enlace <a href="https://www.anaconda.com/distribution/#linux" target="_blank" rel="noopener noreferrer">(Descargar
Python-Anaconda)</a>.
Una vez realizado click en el enlace, se abrirá la siguiente venta

![](/assets/images/GuiaU9.png)

...
order: 4
classType: "clase"
description: "Fundamentos de probabilidad. - Noción de aleatoriedad. - Experimento aleatorio. - Espacio muestral. - Evento de un espacio muestral. Teoría de conjuntos. - Propiedades de teoría de conjuntos Introducción a la probabilidad. - Axiomas de probabilidad. - Propiedades de Probabilidad."
math: true
...
<p>
Plantee los siguientes eventos basados en su correspondiente
descripción.
</p>
<ol type="1">
<li>
...
<ul>
<li>
\(A_1\): sacar un número primo en el dado.
</li>
<li>
\(A_2\): sacar un número 3 en el dado.
</li>
<li>
\(A_3\): sacar un \(8\) en el dado.
</li>
</ul>
<li>
Considere el experimento de espera el tiempo que pasa hasta que el
Decano de Ingenería salga de la oficina a comprar un tinto. Escriba el
evento
</li>
<ul>
<li>
\(B_1\): indica que el decano tarda en menos de \(1\) hora en salir de
la oficina para comprar tinto en la burbuja.
</li>
<li>
\(B_2\): indica que el decano tarda entre \(20\) y \(70\) minutos en
...
<ul>
<li>
\(A_1\): sacar un número primo en un dado de \(6\) caras.
</li>
<li>
\(A_2\): sacar un número \(3\) en un dado de \(6\) caras.
</li>
<li>
\(A_3\): sacar un \(8\) en un dado de \(6\) caras.
</li>
<li>
\(B_1\): indica que el decano tarda en menos de \(1\) hora en salir de
la oficina para comprar tinto en la burbuja.
...
<p>
Basados en lo puntos muestrales de cada uno de los eventos anteriores
</p>
<ol type="1">
<li>
